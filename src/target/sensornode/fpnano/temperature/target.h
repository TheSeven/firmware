...
{ \
    GPIO_CONFIG_PORT( /* PORTA */ \
        /* PA 0 */ MODE_INPUT, TYPE_PUSHPULL, SPEED_50MHZ, PULL_UP, INITCTL_SET, INITVAL_LOW, SPECIAL_SYS, /* Radio IRQ */ \
        /* PA 1 */ MODE_OUTPUT, TYPE_PUSHPULL, SPEED_2MHZ, PULL_NONE, INITCTL_SET, INITVAL_HIGH, SPECIAL_SYS, /* Radio CS */ \
        /* PA 2 */ MODE_OUTPUT, TYPE_PUSHPULL, SPEED_2MHZ, PULL_NONE, INITCTL_SET, INITVAL_LOW, SPECIAL_SYS, /* unused */ \
        /* PA 3 */ MODE_ANALOG, TYPE_PUSHPULL, SPEED_2MHZ, PULL_NONE, INITCTL_SET, INITVAL_LOW, SPECIAL_SYS, /* Battery ADC */ \
        ...
        /* PA 9 */ MODE_ANALOG, TYPE_PUSHPULL, SPEED_2MHZ, PULL_NONE, INITCTL_SET, INITVAL_LOW, SPECIAL_I2C1_PA9, /* I2C SCL */ \
        /* PA10 */ MODE_ANALOG, TYPE_PUSHPULL, SPEED_2MHZ, PULL_NONE, INITCTL_SET, INITVAL_LOW, SPECIAL_I2C1_PA10, /* I2C SDA */ \
...
#define ONEWIRE_PIN PIN_F1

#define SENSORNODE_MAXSENSORS 16
#define SENSORNODE_LEDPIN PIN_A4
#define SENSORNODE_RADIO_NRF24L01P_CEPIN PIN_A4
...
#define SENSORNODE_SENSOR_TEMPERATURE_DS1820
#define SENSORNODE_SENSOR_POWERSUPPLY_STM32VCC_AUXCHANNEL 3
#define SENSORNODE_SENSOR_POWERSUPPLY_STM32VCC_AUXSAMPTIME 0
#define SENSORNODE_SENSOR_POWERSUPPLY_FPNANOBAT
#include "../target.h"
