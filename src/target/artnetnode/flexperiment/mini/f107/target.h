...
{ \
    GPIO_CONFIG_PORT( /* PORTA */ \
        ...
        /* PA 2 */ MODE_2MHZ, CNF_AF_PUSHPULL, INITCTL_SET, INITVAL_HIGH, /* ETH_MDIO */ \
        /* PA 3 */ MODE_INPUT, CNF_IN_FLOATING, INITCTL_SET, INITVAL_LOW, /* unmapped */ \
        ...
        /* PA 9 */ MODE_50MHZ, CNF_AF_PUSHPULL, INITCTL_SET, INITVAL_LOW, /* unmapped */ \
        /* PA10 */ MODE_INPUT, CNF_IN_FLOATING, INITCTL_SET, INITVAL_LOW, /* unmapped */ \
    ...
    GPIO_CONFIG_PORT( /* PORTB */ \
        /* PB 0 */ MODE_INPUT, CNF_IN_FLOATING, INITCTL_SET, INITVAL_LOW, /* unmapped */ \
        /* PB 1 */ MODE_INPUT, CNF_IN_FLOATING, INITCTL_SET, INITVAL_LOW, /* unmapped */ \
        /* PB 2 */ MODE_2MHZ, CNF_OUT_PUSHPULL, INITCTL_SET, INITVAL_HIGH, /* DMX1 TXEN */ \
        ...
        /* PB10 */ MODE_50MHZ, CNF_AF_PUSHPULL, INITCTL_SET, INITVAL_LOW, /* unmapped */ \
    ...
    GPIO_CONFIG_PORT( /* PORTC */ \
        ...
        /* PC 1 */ MODE_2MHZ, CNF_AF_PUSHPULL, INITCTL_SET, INITVAL_HIGH, /* ETH_MDC */ \
        ...
        /* PC 8 */ MODE_INPUT, CNF_IN_FLOATING, INITCTL_SET, INITVAL_LOW, /* SD D0 */ \
        /* PC 9 */ MODE_INPUT, CNF_IN_FLOATING, INITCTL_SET, INITVAL_LOW, /* SD D1 */ \
        /* PC10 */ MODE_50MHZ, CNF_AF_PUSHPULL, INITCTL_SET, INITVAL_LOW, /* unmapped */ \
        /* PC11 */ MODE_INPUT, CNF_IN_FLOATING, INITCTL_SET, INITVAL_LOW, /* SD D3 */ \
        /* PC12 */ MODE_50MHZ, CNF_AF_PUSHPULL, INITCTL_SET, INITVAL_LOW, /* unmapped */ \
        /* PC13 */ MODE_2MHZ, CNF_OUT_PUSHPULL, INITCTL_SET, INITVAL_LOW, /* unmapped */ \
