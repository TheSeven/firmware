...
{ \
    GPIO_CONFIG_PORT( /* PORTA */ \
        ...
        /* PA 9 */ MODE_SPECIAL, TYPE_PUSHPULL, SPEED_2MHZ, PULL_UP, INITCTL_SET, INITVAL_LOW, SPECIAL_USART1_PA9, /* ESP8266 TX */ \
    ...
    GPIO_CONFIG_PORT( /* PORTB */ \
        ...
        /* PB 8 */ MODE_SPECIAL, TYPE_PUSHPULL, SPEED_2MHZ, PULL_NONE, INITCTL_SET, INITVAL_LOW, SPECIAL_TIM16_PB8, /* LCD Backlight */ \
        /* PB 9 */ MODE_INPUT, TYPE_PUSHPULL, SPEED_2MHZ, PULL_NONE, INITCTL_SET, INITVAL_LOW, SPECIAL_SYS, /* OneWire Bus */ \
        /* PB10 */ MODE_SPECIAL, TYPE_PUSHPULL, SPEED_2MHZ, PULL_NONE, INITCTL_SET, INITVAL_LOW, SPECIAL_TIM2, /* LED-Strip 1 */ \
        /* PB11 */ MODE_SPECIAL, TYPE_PUSHPULL, SPEED_2MHZ, PULL_NONE, INITCTL_SET, INITVAL_LOW, SPECIAL_TIM2, /* LED-Strip 2 */ \
...
#define SDHC_SPI_ENABLE_BUGGY_CARD_QUIRKS
