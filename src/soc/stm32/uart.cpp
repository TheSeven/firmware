...
namespace STM32
{
    ...
    UART UART::UART1 = UART(0);
    UART UART::UART2 = UART(1);
    UART UART::UART3 = UART(2);
    UART UART::UART4 = UART(3);
    UART UART::UART5 = UART(4);
    UART UART::UART6 = UART(5);
    UART UART::UART7 = UART(6);
    UART UART::UART8 = UART(7);
}
