...
WS2811::STM32Driver::STM32Driver(const WS2811::STM32Driver::Config* config)
...
void WS2811::STM32Driver::sendFrame(void** data, int pixels)
{
    cancelSending();
...
bool WS2811::STM32Driver::isSending()
{
    return timer->CR1.b.CEN;
}

void WS2811::STM32Driver::cancelSending()
{
    timer->CR1.d32 = 0;
    dmaStream->CCR.d32 = 0;
}

void WS2811::STM32Driver::handleIrq()
{
...
void __attribute__((optimize("-Os","-fomit-frame-pointer"))) WS2811::STM32Driver::fillDmaBuffer(uint8_t* buffer)
{
